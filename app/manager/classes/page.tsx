...
export default function ClassesPage() {
  ...
  return (
    <div className="relative w-full overflow-x-hidden">
      ...
      <Card className="bg-black p-4 sm:p-6 lg:p-8 shadow-2xl border border-red-500/50 w-full max-w-[1069px] mx-auto min-h-[600px] sm:min-h-[800px] lg:min-h-[1000px] overflow-x-hidden">
        <ClassesView onLoadingChange={setLoading} />
      </Card>
    </div>
  );
}
