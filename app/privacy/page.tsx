        ...
        <Card className="border border-red-500/20 bg-gradient-to-br from-black via-slate-950 to-black p-6 sm:p-8 shadow-2xl">
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section className="space-y-4">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Si tienes preguntas sobre esta política de privacidad o sobre cómo manejamos tu información, puedes contactarnos a través de nuestra página de <Link href="/contact" className="text-red-400 hover:text-red-300 underline">contacto</Link>.
              </p>
            </section>
          </div>
        </Card>
